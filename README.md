...
<img width="859" height="511" alt="image" src="https://github.com/user-attachments/assets/b2e3581b-f408-4283-bd27-4e30021a7757" />

Hopefully this visual bug will be fixed by then but this is what it will look like.

From there you then upload the spss related to the trial case so that the script can find the highlighted question within the spss and make the recoding script
